      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex items-center gap-4 mb-6">
            <GraduationCap className="w-12 h-12 text-[#B78B1E]" />
            <h1 className="text-5xl md:text-6xl font-bold text-foreground">IFBB Academia</h1>
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            <Badge className="bg-[#B78B1E]/20 text-[#B78B1E] border-[#B78B1E]/30 text-base px-4 py-2">
